...
**NOTE:** To avoid conflicts with the FPGA on the common STM32 pins when it is not necessary to use any STM32 GPIO, it is recommended to load the "neutral" [STM32_PB1_Blink.ino](https://github.com/SuperFabius/The-Thing-FPGA-STM32/blob/master/STM32%20Sketch/STM32_PB1_Blink.ino) sketch on the STM32.
